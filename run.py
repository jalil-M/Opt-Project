...
build_validation_plots(adam_val_loss, rms_val_loss, sgd_val_loss, 'Loss');

#f1-score again epochs
sgd_val_f1,adam_val_f1, rms_val_f1= run_training_benchmarking_f1(data)
build_validation_plots(adam_val_f1, rms_val_f1, sgd_val_f1, 'F1-score');
